...
public class LoseSlashActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_lose_slash);
    ...
    protected void onStart() {
        ...
        new Timer().schedule(new TimerTask() {
            @Override
            public void run() {
                Intent finishedGameActivity = new Intent(LoseSlashActivity.this, FinishedGameActivity.class);
